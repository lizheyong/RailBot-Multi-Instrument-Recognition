...
def decimal_detection(img_src):
    ...
    if img.shape[0] < 75:
        ...
        dilate_kernel = np.ones((9, 2), np.uint8)
    elif 75 < img.shape[0] < 100:
        # 红色差不多77、79
        ero_kernel = cv2.getStructuringElement(cv2.MORPH_RECT, (3, 5))
        dilate_kernel = np.ones((6, 2), np.uint8)
    else:
...
if __name__ == '__main__':
    ...
    img_src = r"C:\Users\zheyong\Desktop\digital(1)\chucuo\3_1.jpg"
