...
# training process
displayInterval = 8 # interval to be print the train loss
valInterval = 8 # interval to val the model loss and accuray
saveInterval = 8 # interval to save model
n_val_disp = 8 # number of samples to display when val the model
